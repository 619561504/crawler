 ...
 */
package com.wutianyi.railgun.action.enums;

import java.util.HashMap;
import java.util.Map;

import com.wutianyi.railgun.action.Action;
import com.wutianyi.railgun.action.impl.FetcherAction;
import com.wutianyi.railgun.action.impl.MainAction;
import com.wutianyi.railgun.action.impl.ParserAction;
import com.wutianyi.railgun.action.impl.ShellAction;
